...
import com.jimplush.goose.texthelpers.StringReplacement;
import com.jimplush.goose.texthelpers.StringSplitter;
...
public class ContentExtractor {
	...
	public Article performExtraction(String urlToCrawl, String rawHtml) {
		...
		try {
			...
			// reparse the document to tidy up any cleansing artifacts
			doc = parseWrapper.parse(documentCleaner.clean(doc).outerHtml(), urlToCrawl);
