...
//  }
  ...
  public void testYahooNews() {
    ...
    runArticleAssertions(article, "With the deficit supercommittee charged with finding $1.2 trillion in savings teetering on the brink of failure");
  }
  ...
  public void testDailyBeast() {
    ...
    runArticleAssertions(article, "Today, as wordsmiths, politicos and Kennedyophiles", "http://www.thedailybeast.com/content/dailybeast/articles/2010/11/01/ted-sorensen-speechwriter-behind-jfks-best-jokes/_jcr_content/body/image_0.img.jpg/1302761778490.jpg");
  }
